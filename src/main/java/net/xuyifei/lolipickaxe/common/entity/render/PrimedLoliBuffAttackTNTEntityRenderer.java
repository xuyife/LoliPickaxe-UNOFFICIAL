...
@OnlyIn(Dist.CLIENT)
public class PrimedLoliBuffAttackTNTEntityRenderer extends EntityRenderer<PrimedLoliBuffAttackTNTEntity> {
    private final BlockRenderDispatcher blockRenderer;

    public PrimedLoliBuffAttackTNTEntityRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull PrimedLoliBuffAttackTNTEntity entity) {
